<template>
  <div id="app">
    ...
    <plant-list/>
    <!-- <tasks> -->
    <!--<section id="tasks" class="todo-wrapper container-md">
      ...
      <div class="control-buttons">
        <button class="button button-secondary" v-if="completed.length > 0" @click="toggleShowComplete"><span
            v-if="!showComplete">Show</span><span v-else>Hide</span> Complete</button>
...
@font-face {
  ...
  src: url("./fonts/GreatWarriorPersonaluse.woff2") format("woff2"),
    url("./fonts/GreatWarriorPersonaluse.woff") format("woff");
  font-weight: normal;
  font-style: normal;
  font-display: swap;
}
